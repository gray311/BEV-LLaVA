...
Example:
    python update_infos_to_v2.py \
        --dataset nuscenes \
        --pkl-path /home/scratch.chaoweix_nvresearch/av/AV-GPT/data/nuscenes/nuscenes_infos_temporal_test.pkl \
        --out-dir /home/scratch.chaoweix_nvresearch/av/AV-GPT/data/nuscenes/
"""
...
def update_nuscenes_infos(pkl_path, out_dir):
    ...
    nusc = NuScenes(
        ...
        dataroot='/home/scratch.chaoweix_nvresearch/av/AV-GPT/data/nuscenes/',
        verbose=True)
